let Hotel,fs,Order;_a80‍.x([["create",()=>create],["hotels",()=>hotels],["image",()=>image],["sellerHotels",()=>sellerHotels],["remove",()=>remove],["read",()=>read],["update",()=>update],["userHotelBookings",()=>userHotelBookings],["isAlreadyBooked",()=>isAlreadyBooked],["searchListings",()=>searchListings]]);_a80‍.w("../models/hotel",[["default",["Hotel"],function(v){Hotel=v}]]);_a80‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_a80‍.w("../models/order",[["default",["Order"],function(v){Order=v}]]);
    ...
    try {
        ...
        hotel.save((err, result) => {
            if(err) {
                _a80‍.g.console.log("saving hotel error => ", err)
                res.status(400).send('Error saving')
            }
            res.json(result);
        })
    } catch (err) {
        _a80‍.g.console.log(err)
        res.status(400).json({
            err: err.message
        })
    }
